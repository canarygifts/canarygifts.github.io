...
"use strict";!function(){var e=instantsearch({appId:"4P42FOBOZA",apiKey:"83993b03d87b22e88676627b58d9792f",indexName:"sakura",routing:!0}),t=function(){$("#search-results").addClass("d-none")},n=function(){t(),$("input").val(""),$("input").focus()};$("#search-input").on("keyup keypress",function(e){if(13===(e.keyCode||e.which))return e.preventDefault(),!1;e.target.value?$("#search-results").removeClass("d-none"):t()}),$("#search-input").on("click","button",function(){t()}),$("#search-modal").on("shown.bs.modal",function(){n()}),$("#search-modal").on("hidden.bs.modal",function(){n()}),e.addWidget(instantsearch.widgets.searchBox({autofocus:!0,container:"#search-input",placeholder:"Search",poweredBy:!0})),e.addWidget(instantsearch.widgets.hits({container:"#results-container",reset:!0,templates:{empty:"No Results",item:function(e){var t=e._highlightResult.html.value;return"<li class='list-group-item p-0'><a href='"+e.url+"'><h4>"+e.title+"</a></h4><div>"+t+"</div></li>"}}})),e.start()}();
"use strict";
/*!
 * Font Awesome Free 5.0.13 by @fontawesome - https://fontawesome.com
 * License - https://fontawesome.com/license (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License)
...
/**
     ...
     * this as well.
     */,"fas"===l&&c("fa",e)}("fas",f)})}();
"use strict";!function(o,t,a){o(".highlight code").each(function(t){
